...
/**
 * Prompt view for follow-up queries
 */
class FollowupPromptView extends BasePromptView
{
    /**
    ...
    {
        return 'prompts.system_followup';
    }
    ...
    {
        return 'prompts.user_followup';
    }

    /**
     * Set the query ID for the follow-up prompt
     */
    ...
    /**
     * Set the last SQL call ID for the follow-up prompt
     */
    public function setLastSqlCallId(int $lastSqlCallId): static
    {
        $this->data['last_sql_call_id'] = $lastSqlCallId;
